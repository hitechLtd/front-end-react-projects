...
- Hamburger menu + smooth animation for mobile
- Active link highlighting (using React Router or simple logic)
- Clean component structure
- Easy to customize (colors, links, logo)
- Built with modern React (functional components + hooks)

## 🛠️ Technologies Used

- React (18+)
- React Router DOM (if you're using routing)
- CSS (pure css without any external framework)
